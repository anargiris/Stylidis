const SunIcon = () => {
  return (
    <svg
      ...
      xmlSpace="preserve"
    >
      <circle fill="#FFCE00" cx="248" cy="248" r="142.4" />
      <path
        fill="#FF9D00"
   ...
   S390.4,169.6,390.4,248z"
      ...
      />
      <path fill="#FFCE00" d="M390.4,248c0,78.4-64,131.2-142.4,131.2" />
      <circle fill="#FF9D00" cx="248" cy="59.2" r="10.4" />
      <polygon fill="#FFCE00" points="260.8,24.8 248,28.8 235.2,24.8 248,0 " />
      <circle fill="#FF9D00" cx="248" cy="436.8" r="10.4" />
      <polygon
        fill="#FFCE00"
      ...
      />
      <circle fill="#FF9D00" cx="114.4" cy="381.6" r="10.4" />
      <polygon
        fill="#FFCE00"
   ...
   C447.2,253.6,442.4,258.4,436.8,258.4z"
      ...
      />
      <circle fill="#FF9D00" cx="59.2" cy="248" r="10.4" />
      <polygon fill="#FFCE00" points="24.8,235.2 28.8,248 24.8,260.8 0,248 " />
      <path
        fill="#FF9D00"
     ...
     C331.2,67.2,333.6,73.6,331.2,78.4z"
      ...
      />
      <circle fill="#FFCE00" cx="174.4" cy="421.6" r="10.4" />
      <polygon
        fill="#FF9D00"
   ...
   C67.2,164.8,73.6,162.4,78.4,164.8z"
      ...
      />
      <circle fill="#FFCE00" cx="318.4" cy="422.4" r="10.4" />
      <polygon
        fill="#FF9D00"
